import{r as d,j as n,B as p,F as m}from"./index-CKqfvLoB.js";import{u as f,C as g,T as v,P as E,a as P,b as T,c as w}from"./PropTable-BzD4cJVp.js";import{h as o}from"./HyperSpeedPresets-BuQfJXSx.js";import{O as b}from"./OpenInStudioButton-skw5opkr.js";import{u as x}from"./useForceRerender-0lK0qxlp.js";import{D as A}from"./Dependencies-DmSBXzNX.js";import{P as y}from"./PreviewSelect-CM4Sns8B.js";import{C as S}from"./Customize-BaUKAf5J.js";import{B as F}from"./BackgroundContent-D3IuLIX4.js";import R from"./Hyperspeed-CiOqgqrl.js";import"./rotate-ccw-BMSfA2a1.js";import"./CodeHighlighter-ChUXWT8y.js";import"./field-DGUMYGrq.js";import"./PreviewSwitch-B0BSuWrO.js";import"./switch-CqqRi5Az.js";import"./three.module-DbwSNGae.js";import"./index-XT30UhE1.js";const L=`export const hyperspeedPresets = {
  one: {
    onSpeedUp: () => {},
    onSlowDown: () => {},
...
`,C=`import { useEffect, useRef } from 'react';
...
export default Hyperspeed;
`,H=`import { useEffect, useRef, FC } from 'react';
import * as THREE from 'three';
import { BloomEffect, EffectComposer, EffectPass, RenderPass, SMAAEffect, SMAAPreset } from 'postprocessing';
...
export default Hyperspeed;
`,D=`import { useEffect, useRef, FC } from 'react';
import * as THREE from 'three';
import { BloomEffect, EffectComposer, EffectPass, RenderPass, SMAAEffect, SMAAPreset } from 'postprocessing';
...
export default Hyperspeed;
`,I={dependencies:"three postprocessing",usage:`import Hyperspeed from './Hyperspeed';
...
/>`,presets:L,code:C,css:M,tailwind:k,tsCode:H,tsTailwind:D},s={activePreset:"one"},Q=()=>{const{props:t,updateProp:r,resetProps:i,hasChanges:a}=f(s),{activePreset:e}=t,[c]=x(),u=d.useMemo(()=>[{name:"effectOptions",type:"object",default:'See the "code" tab for default values and presets.',description:"The highly customizable configuration object for the effect, controls things like colors, distortion, line properties, etc."}],[]),h=[{value:"one",label:"Cyberpunk"},{value:"two",label:"Akira"},{value:"three",label:"Golden"},{value:"four",label:"Split"},{value:"five",label:"Highway"}];return n.jsx(g,{props:t,defaultProps:s,resetProps:i,hasChanges:a,demoOnlyProps:["activePreset"],computedProps:{effectOptions:o[e]},children:n.jsxs(v,{children:[n.jsxs(E,{children:[n.jsxs(p,{position:"relative",className:"demo-container",overflow:"hidden",h:600,cursor:"pointer",p:0,mb:4,children:[n.jsx(R,{effectOptions:o[e]}),n.jsx(F,{pillText:"New Background",headline:"Click & hold to see the real magic of hyperspeed!"})]},c),n.jsx(m,{justify:"flex-end",mt:2,mb:-2,children:n.jsx(b,{backgroundId:"hyperspeed",currentProps:{preset:e},defaultProps:{preset:"one"}})}),n.jsx(S,{children:n.jsx(y,{title:"Animation Preset",options:h,value:e,name:"tiltDirection",width:150,onChange:l=>{r("activePreset",l)}})}),n.jsx(P,{data:u}),n.jsx(A,{dependencyList:["three","postprocessing"]})]}),n.jsx(T,{children:n.jsx(w,{codeObject:I,componentName:"Hyperspeed"})})]})})};export{Q as default};
