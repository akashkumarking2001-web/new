import{r as p,j as l,R as M,T as S,P as v,M as f,B as R}from"./index-CKqfvLoB.js";import{u as E,C,T as z,P as O,a as P,b as L,c as D}from"./PropTable-BzD4cJVp.js";import{D as B}from"./Dependencies-DmSBXzNX.js";import{C as I}from"./Customize-BaUKAf5J.js";import{P as m}from"./PreviewSlider-25yjOF_X.js";import{u as U}from"./useForceRerender-0lK0qxlp.js";import{C as W}from"./Camera-HNSge1c7.js";import{P as w}from"./Plane-Czq6_i-L.js";import{T as x}from"./Texture-BkQWYNP2.js";import"./rotate-ccw-BMSfA2a1.js";import"./CodeHighlighter-ChUXWT8y.js";import"./slider-P7kYMDWb.js";const k=`.circular-gallery {
  width: 100%;
  height: 100%;
  overflow: hidden;
  cursor: grab;
...
`,H=`import { Camera, Mesh, Plane, Program, Renderer, Texture, Transform } from 'ogl';
...
`,F={dependencies:"ogl",usage:`import CircularGallery from './CircularGallery'

<div style={{ height: '600px', position: 'relative' }}>
  <CircularGallery bend={3} textColor="#ffffff" borderRadius={0.05} scrollEase={0.02}/>
</div>`,code:H,css:k,tailwind:G,tsCode:j,tsTailwind:A};function X(o,e){let n;return function(...i){clearTimeout(n),n=setTimeout(()=>o.apply(this,i),e)}}function V(o,e,n){return o+(e-o)*n}function _(o){const e=Object.getPrototypeOf(o);Object.getOwnPropertyNames(e).forEach(n=>{n!=="constructor"&&typeof o[n]=="function"&&(o[n]=o[n].bind(o))})}function N(o,e,n="bold 30px monospace",i="black"){const t=document.createElement("canvas"),s=t.getContext("2d");s.font=n;const a=s.measureText(e),r=Math.ceil(a.width),h=Math.ceil(parseInt(n,10)*1.2);t.width=r+20,t.height=h+20,s.font=n,s.fillStyle=i,s.textBaseline="middle",s.textAlign="center",s.clearRect(0,0,t.width,t.height),s.fillText(e,t.width/2,t.height/2);const c=new x(o,{generateMipmaps:!1});return c.image=t,{texture:c,width:t.width,height:t.height}}class q{constructor({gl:e,plane:n,renderer:i,text:t,textColor:s="#545050",font:a="30px sans-serif"}){_(this),this.gl=e,this.plane=n,this.renderer=i,this.text=t,this.textColor=s,this.font=a,this.createMesh()}createMesh(){const{texture:e,width:n,height:i}=N(this.gl,this.text,this.font,this.textColor),t=new w(this.gl),s=new v(this.gl,{vertex:`
        attribute vec3 position;
        attribute vec2 uv;
        uniform mat4 modelViewMatrix;
        uniform mat4 projectionMatrix;
      ...
      `,uniforms:{tMap:{value:e}},transparent:!0});this.mesh=new f(this.gl,{geometry:t,program:s});const a=n/i,r=this.plane.scale.y*.15,h=r*a;this.mesh.scale.set(h,r,1),this.mesh.position.y=-this.plane.scale.y*.5-r*.5-.05,this.mesh.setParent(this.plane)}}class Y{constructor({geometry:e,gl:n,image:i,index:t,length:s,renderer:a,scene:r,screen:h,text:c,viewport:u,bend:d,textColor:b,borderRadius:y=0,font:T}){this.extra=0,this.geometry=e,this.gl=n,this.image=i,this.index=t,this.length=s,this.renderer=a,this.scene=r,this.screen=h,this.text=c,this.viewport=u,this.bend=d,this.textColor=b,this.borderRadius=y,this.font=T,this.createShader(),this.createMesh(),this.createTitle(),this.onResize()}createShader(){const e=new x(this.gl,{generateMipmaps:!0});this.program=new v(this.gl,{depthTest:!1,depthWrite:!1,vertex:`
        precision highp float;
        attribute vec3 position;
        attribute vec2 uv;
        uniform mat4 modelViewMatrix;
