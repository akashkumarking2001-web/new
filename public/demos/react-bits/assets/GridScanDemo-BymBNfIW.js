import{r as C,j as n,B as M,F as d,a as v,d as x}from"./index-CKqfvLoB.js";import{u as k,C as D,T as P,P as V,a as A,b as I,c as U}from"./PropTable-BzD4cJVp.js";import{C as Y}from"./Customize-BaUKAf5J.js";import{D as L}from"./Dependencies-DmSBXzNX.js";import{P as a}from"./PreviewSlider-25yjOF_X.js";import{P as f}from"./PreviewSwitch-B0BSuWrO.js";import{u as F}from"./useForceRerender-0lK0qxlp.js";import{GridScan as H}from"./GridScan-B-Tknyf5.js";import{B as O}from"./BackgroundContent-D3IuLIX4.js";import{O as W}from"./OpenInStudioButton-skw5opkr.js";import"./rotate-ccw-BMSfA2a1.js";import"./CodeHighlighter-ChUXWT8y.js";import"./slider-P7kYMDWb.js";import"./switch-CqqRi5Az.js";import"./index-XT30UhE1.js";import"./three.module-DbwSNGae.js";const z=`import { useEffect, useRef, useState } from 'react';
...
`,B=`import React, { useEffect, useRef, useState } from 'react';
import { EffectComposer, RenderPass, EffectPass, BloomEffect, ChromaticAberrationEffect } from 'postprocessing';
import * as THREE from 'three';
import * as faceapi from 'face-api.js';
import './GridScan.css';
...
`,X=`import React, { useEffect, useRef, useState } from 'react';
import { EffectComposer, RenderPass, EffectPass, BloomEffect, ChromaticAberrationEffect } from 'postprocessing';
import * as THREE from 'three';
import * as faceapi from 'face-api.js';
...
`,N={dependencies:"three",usage:`import GridScan from './GridScan';
...
<div style={{ width: '100%', height: '600px', position: 'relative' }}>
  <GridScan
    ...
    noiseIntensity={0.01}
  />
</div>`,code:z,css:G,tailwind:j,tsCode:B,tsTailwind:X},_={lineThickness:1,gridScale:.1,lineJitter:.1,linesColor:"#392e4e",scanColor:"#FF9FFC",enablePost:!0,chromaticAberration:.002,noiseIntensity:.01,scanGlow:.5,scanSoftness:2,enableWebcam:!1,showPreview:!1},mn=()=>{const{props:b,updateProp:t,resetProps:S,hasChanges:w}=k(_),{lineThickness:o,gridScale:i,lineJitter:r,linesColor:s,scanColor:l,enablePost:h,chromaticAberration:p,noiseIntensity:c,scanGlow:u,scanSoftness:m,enableWebcam:y,showPreview:g}=b,[R,T]=F(),E=C.useMemo(()=>[{name:"enableWebcam",type:"boolean",default:"false",description:"Enable face tracking via webcam."},{name:"showPreview",type:"boolean",default:"false",description:"Show webcam preview/debug HUD."},{name:"modelsPath",type:"string",default:"CDN URL",description:"Path/URL to face-api.js models."},{name:"sensitivity",type:"number",default:"0.55",description:"Overall responsiveness to input."},{name:"lineThickness",type:"number",default:"1",description:"Grid line thickness."},{name:"linesColor",type:"string",default:"'#392e4e'",description:"Color of the grid lines."},{name:"gridScale",type:"number",default:"0.1",description:"Grid spacing scale (smaller = denser)."},{name:"lineStyle",type:"'solid' | 'dashed' | 'dotted'",default:"'solid'",description:"Grid line style."},{name:"lineJitter",type:"number",default:"0.1",description:"Animated jitter along the grid lines."},{name:"enablePost",type:"boolean",default:"true",description:"Enable post-processing effects."},{name:"bloomIntensity",type:"number",default:"0",description:"Bloom strength."},{name:"bloomThreshold",type:"number",default:"0",description:"Bloom luminance threshold."},{name:"bloomSmoothing",type:"number",default:"0",description:"Bloom threshold smoothing."},{name:"chromaticAberration",type:"number",default:"0.002",description:"Chromatic aberration offset (post)."},{name:"noiseIntensity",type:"number",default:"0.01",description:"Additive film grain intensity."},{name:"scanColor",type:"string",default:"'#FF9FFC'",description:"Color of the scan beam/aura."},{name:"scanOpacity",type:"number",default:"0.4",description:"Opacity of the scan effect."},{name:"scanDirection",type:"'forward' | 'backward' | 'pingpong'",default:"'pingpong'",description:"Scan motion."},{name:"scanSoftness",type:"number",default:"2",description:"Softness of scan band edges."},{name:"scanGlow",type:"number",default:"0.5",description:"Relative width/intensity of glow."},{name:"scanPhaseTaper",type:"number",default:"0.9",description:"Fade-in/out window for the phase."},{name:"scanDuration",type:"number",default:"2.0",description:"Duration of a scan cycle (seconds)."},{name:"scanDelay",type:"number",default:"2.0",description:"Delay between scan cycles (seconds)."},{name:"enableGyro",type:"boolean",default:"false",description:"Use device orientation for input."},{name:"scanOnClick",type:"boolean",default:"false",description:"Trigger a scan when clicking."},{name:"snapBackDelay",type:"number",default:"250",description:"Delay (ms) before input recenters."},{name:"className",type:"string",default:"''",description:"Additional CSS classes."},{name:"style",type:"React.CSSProperties",default:"{}",description:"Inline style overrides."}],[]);return n.jsx(D,{resetProps:S,hasChanges:w,forceRerender:T,children:n.jsxs(P,{children:[n.jsxs(V,{children:[n.jsxs(M,{position:"relative",className:"demo-container",h:600,p:0,overflow:"hidden",children:[n.jsx(H,{lineThickness:o,gridScale:i,lineJitter:r,linesColor:s,scanColor:l,enablePost:h,chromaticAberration:p,noiseIntensity:c,scanGlow:u,scanSoftness:m,enableWebcam:y,showPreview:g},R),n.jsx(O,{pillText:"New Background",headline:"Hold on, scanning for Angular users."})]}),n.jsx(d,{justify:"flex-end",mt:2,mb:-2,children:n.jsx(W,{backgroundId:"grid-scan",currentProps:{lineThickness:o,linesColor:s,scanColor:l,gridScale:i,lineJitter:r,noiseIntensity:c,scanGlow:u,scanSoftness:m},defaultProps:{sensitivity:.55,lineThickness:1,linesColor:"#392e4e",scanColor:"#FF9FFC",scanOpacity:.4,gridScale:.1,lineStyle:"solid",lineJitter:.1,scanDirection:"pingpong",noiseIntensity:.01,scanGlow:.5,scanSoftness:2,scanDuration:2,scanDelay:2,scanOnClick:!1}})}),n.jsxs(Y,{children:[n.jsxs(d,{alignItems:"center",mb:4,gap:2,children:[n.jsx(v,{fontSize:"sm",children:"Lines Color"}),n.jsx(x,{type:"color",value:s,onChange:e=>t("linesColor",e.target.value),width:"50px"})]}),n.jsxs(d,{alignItems:"center",mb:4,gap:2,children:[n.jsx(v,{fontSize:"sm",children:"Scan Color"}),n.jsx(x,{type:"color",value:l,onChange:e=>t("scanColor",e.target.value),width:"50px"})]}),n.jsx(a,{title:"Line Thickness",min:1,max:4,step:.1,value:o,onChange:e=>t("lineThickness",e)}),n.jsx(a,{title:"Grid Scale",min:.02,max:.5,step:.01,value:i,onChange:e=>t("gridScale",e)}),n.jsx(a,{title:"Line Jitter",min:0,max:1,step:.01,value:r,onChange:e=>t("lineJitter",e)}),n.jsx(a,{title:"Scan Glow",min:.1,max:3,step:.1,value:u,onChange:e=>t("scanGlow",e)}),n.jsx(a,{title:"Scan Softness",min:.1,max:4,step:.1,value:m,onChange:e=>t("scanSoftness",e)}),n.jsx(f,{title:"Enable Post",isChecked:h,onChange:e=>t("enablePost",e)}),n.jsx(a,{title:"Chromatic Aberration",min:0,max:.01,step:5e-4,value:p,onChange:e=>t("chromaticAberration",e)}),n.jsx(a,{title:"Noise Intensity",min:0,max:.1,step:.005,value:c,onChange:e=>t("noiseIntensity",e)}),n.jsx(f,{title:"Enable Webcam",isChecked:y,onChange:e=>t("enableWebcam",e)}),n.jsx(f,{title:"Show Preview HUD",isChecked:g,onChange:e=>t("showPreview",e)})]}),n.jsx(A,{data:E}),n.jsx(L,{dependencyList:["three"]})]}),n.jsx(I,{children:n.jsx(U,{codeObject:N,componentName:"GridScan"})})]})})};export{mn as default};
