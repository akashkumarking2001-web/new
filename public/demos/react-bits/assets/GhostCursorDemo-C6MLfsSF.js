import{r as b,j as e,B as E,a as h,F as R,d as P}from"./index-CKqfvLoB.js";import{u as M,C as T,T as w,P as S,a as B,b as C,c as D}from"./PropTable-BzD4cJVp.js";import{C as H}from"./Customize-BaUKAf5J.js";import{D as A}from"./Dependencies-DmSBXzNX.js";import{P as r}from"./PreviewSlider-25yjOF_X.js";import{O as L}from"./OpenInStudioButton-skw5opkr.js";import I from"./GhostCursor-SVJIrhQZ.js";import"./rotate-ccw-BMSfA2a1.js";import"./CodeHighlighter-ChUXWT8y.js";import"./slider-P7kYMDWb.js";import"./three.module-DbwSNGae.js";const U=`import { useEffect, useMemo, useRef } from 'react';
...
`,O=`import { useEffect, useMemo, useRef } from 'react';
import * as THREE from 'three';
import { EffectComposer } from 'three/examples/jsm/postprocessing/EffectComposer.js';
import { RenderPass } from 'three/examples/jsm/postprocessing/RenderPass.js';
import { UnrealBloomPass } from 'three/examples/jsm/postprocessing/UnrealBloomPass.js';
...
export default GhostCursor;
`,j=`import React, { useEffect, useMemo, useRef } from 'react';
import * as THREE from 'three';
import { EffectComposer } from 'three/examples/jsm/postprocessing/EffectComposer.js';
import { RenderPass } from 'three/examples/jsm/postprocessing/RenderPass.js';
import { UnrealBloomPass } from 'three/examples/jsm/postprocessing/UnrealBloomPass.js';
...
export default GhostCursor;
`,_=`import React, { useEffect, useMemo, useRef } from 'react';
import * as THREE from 'three';
import { EffectComposer } from 'three/examples/jsm/postprocessing/EffectComposer.js';
import { RenderPass } from 'three/examples/jsm/postprocessing/RenderPass.js';
import { UnrealBloomPass } from 'three/examples/jsm/postprocessing/UnrealBloomPass.js';
...
export default GhostCursor;
`,z={dependencies:"three",usage:`import GhostCursor from './GhostCursor'
...
<div style={{ height: 600, position: 'relative' }}>
  <GhostCursor
    ...
    fadeDurationMs={1500}
  />
</div>`,code:U,css:F,tailwind:O,tsCode:j,tsTailwind:_},m={trailLength:50,inertia:.5,grainIntensity:.05,bloomStrength:.1,bloomRadius:1,bloomThreshold:.025,brightness:2,color:"#B19EEF",fadeDelayMs:1e3,fadeDurationMs:1500},Q=()=>{const{props:f,updateProp:t,resetProps:g,hasChanges:x}=M(m),{trailLength:o,inertia:s,grainIntensity:i,bloomStrength:a,bloomRadius:c,bloomThreshold:d,brightness:l,color:u,fadeDelayMs:p,fadeDurationMs:v}=f,y=b.useMemo(()=>[{name:"className",type:"string",default:"''",description:"Additional CSS class names for the container."},{name:"style",type:"React.CSSProperties",default:"{}",description:"Inline styles for the container element."},{name:"trailLength",type:"number",default:"50",description:"Number of points stored for the cursor trail (longer = longer smear)."},{name:"inertia",type:"number",default:"0.5",description:"Velocity retention when the pointer stops. Higher values make the cursor glide longer."},{name:"grainIntensity",type:"number",default:"0.05",description:"Strength of the film grain post-processing pass."},{name:"bloomStrength",type:"number",default:"0.1",description:"UnrealBloom effect strength."},{name:"bloomRadius",type:"number",default:"1.0",description:"UnrealBloom radius controlling spread of glow."},{name:"bloomThreshold",type:"number",default:"0.025",description:"UnrealBloom threshold; lower includes more pixels in bloom."},{name:"brightness",type:"number",default:"1",description:"Final brightness multiplier applied to the effect color."},{name:"color",type:"string",default:"'#B19EEF'",description:"Base color of the ghost cursor effect."},{name:"mixBlendMode",type:"CSS mix-blend-mode",default:"'screen'",description:"Blend mode used when compositing with page content."},{name:"edgeIntensity",type:"number",default:"0",description:"Darkening near edges of the canvas. 0 = none, 1 = strongest."},{name:"maxDevicePixelRatio",type:"number",default:"0.5",description:"Upper cap for devicePixelRatio to control render cost on high-DPR displays."},{name:"targetPixels",type:"number",default:"auto (~1.3e6 desktop, ~0.9e6 touch)",description:"Pixel budget. Resolution is dynamically scaled to keep total pixel count under this budget."},{name:"fadeDelayMs",type:"number",default:"auto (1000 desktop, 500 touch)",description:"Idle delay before the trail starts to fade after pointer leaves/stops."},{name:"fadeDurationMs",type:"number",default:"auto (1500 desktop, 1000 touch)",description:"Duration of the trail fade-out once the delay has elapsed."},{name:"zIndex",type:"number",default:"10",description:"z-index applied to the canvas for layering above/below content."}],[]);return e.jsx(T,{props:f,defaultProps:m,resetProps:g,hasChanges:x,children:e.jsxs(w,{children:[e.jsxs(S,{children:[e.jsxs(E,{position:"relative",className:"demo-container",h:600,overflow:"hidden",children:[e.jsx(I,{trailLength:o,inertia:s,grainIntensity:i,bloomStrength:a,bloomRadius:c,bloomThreshold:d,brightness:l,color:u,fadeDelayMs:p,fadeDurationMs:v}),e.jsx(h,{position:"absolute",userSelect:"none",fontSize:"clamp(3rem, 8vw, 8rem)",zIndex:11,fontWeight:900,color:"#060010",children:"Boo!"})]}),e.jsx(R,{justify:"flex-end",mt:2,mb:-2,children:e.jsx(L,{backgroundId:"ghost-cursor",currentProps:{trailLength:o,inertia:s,grainIntensity:i,bloomStrength:a,bloomRadius:c,brightness:l,color:u},defaultProps:m})}),e.jsxs(H,{children:[e.jsxs(R,{alignItems:"center",mb:4,children:[e.jsx(h,{fontSize:"sm",mr:2,children:"Color"}),e.jsx(P,{type:"color",value:u,onChange:n=>t("color",n.target.value),width:"50px"})]}),e.jsx(r,{title:"Trail Length",min:10,max:50,step:5,value:o,onChange:n=>t("trailLength",n)}),e.jsx(r,{title:"Inertia",min:0,max:.99,step:.01,value:s,onChange:n=>t("inertia",n)}),e.jsx(r,{title:"Grain Intensity",min:0,max:.5,step:.01,value:i,onChange:n=>t("grainIntensity",n)}),e.jsx(r,{title:"Bloom Strength",min:0,max:10,step:.05,value:a,onChange:n=>t("bloomStrength",n)}),e.jsx(r,{title:"Bloom Radius",min:0,max:10,step:.05,value:c,onChange:n=>t("bloomRadius",n)}),e.jsx(r,{title:"Bloom Threshold",min:0,max:1,step:.01,value:d,onChange:n=>t("bloomThreshold",n)}),e.jsx(r,{title:"Brightness",min:0,max:10,step:.1,value:l,onChange:n=>t("brightness",n)}),e.jsx(r,{title:"Fade Delay (ms)",min:0,max:3e3,step:100,value:p,onChange:n=>t("fadeDelayMs",n)}),e.jsx(r,{title:"Fade Duration (ms)",min:100,max:5e3,step:100,value:v,onChange:n=>t("fadeDurationMs",n)})]}),e.jsx(B,{data:y}),e.jsx(A,{dependencyList:["three"]})]}),e.jsx(C,{children:e.jsx(D,{codeObject:z,componentName:"GhostCursor"})})]})})};export{Q as default};
