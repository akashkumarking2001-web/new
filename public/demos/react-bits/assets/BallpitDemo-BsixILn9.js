import{r as v,j as n,B as y,F as b}from"./index-CKqfvLoB.js";import{u as x,C as w,T as z,P,a as C,b as R,c as A}from"./PropTable-BzD4cJVp.js";import{O as M}from"./OpenInStudioButton-skw5opkr.js";import{R as D}from"./RefreshButton-CpmD4Uvc.js";import{D as S}from"./Dependencies-DmSBXzNX.js";import{u as E}from"./useForceRerender-0lK0qxlp.js";import{P as s}from"./PreviewSlider-25yjOF_X.js";import{P as L}from"./PreviewSwitch-B0BSuWrO.js";import{C as I}from"./Customize-BaUKAf5J.js";import{B}from"./BackgroundContent-D3IuLIX4.js";import k from"./Ballpit-hdH_Jiqr.js";import"./rotate-ccw-BMSfA2a1.js";import"./CodeHighlighter-ChUXWT8y.js";import"./slider-P7kYMDWb.js";import"./switch-CqqRi5Az.js";import"./three.module-DbwSNGae.js";const j=`import { useRef, useEffect } from 'react';
import {
  Clock as e,
...
export default Ballpit;
`,T=`import React, { useRef, useEffect } from 'react';
import {
  Clock,
  PerspectiveCamera,
  Scene,
...
export default Ballpit;
`,F={dependencies:"three",usage:`//Component inspired by Kevin Levron:
...
<div style={{position: 'relative', overflow: 'hidden', minHeight: '500px', maxHeight: '500px', width: '100%'}}>
  <Ballpit
    ...
    followCursor={true}
  />
</div>`,code:j,tailwind:V,tsCode:T,tsTailwind:O},d={count:100,gravity:.01,friction:.9975,wallBounce:.95,followCursor:!1},tn=()=>{const{props:h,updateProp:i,resetProps:m,hasChanges:f}=x(d),{count:o,gravity:a,friction:r,wallBounce:c,followCursor:l}=h,u=[16777215,0,5384191],[p,t]=E(),g=v.useMemo(()=>[{name:"count",type:"number",default:"200",description:"Sets the number of balls in the ballpit."},{name:"gravity",type:"number",default:"0.5",description:"Controls the gravity affecting the balls."},{name:"friction",type:"number",default:"0.9975",description:"Sets the friction applied to the ball movement."},{name:"wallBounce",type:"number",default:"0.95",description:"Determines how much balls bounce off walls."},{name:"followCursor",type:"boolean",default:"true",description:"Enables or disables the sphere following the cursor."},{name:"colors",type:"array",default:"[0, 0, 0]",description:"Defines the colors of the balls."},{name:"ambientColor",type:"number",default:"16777215",description:"Sets the ambient light color."},{name:"ambientIntensity",type:"number",default:"1",description:"Controls the intensity of ambient light."},{name:"lightIntensity",type:"number",default:"200",description:"Sets the intensity of the main light source."},{name:"minSize",type:"number",default:"0.5",description:"Specifies the minimum size of the balls."},{name:"maxSize",type:"number",default:"1",description:"Specifies the maximum size of the balls."},{name:"size0",type:"number",default:"1",description:"Initial size value for the cursor ball."},{name:"maxVelocity",type:"number",default:"0.15",description:"Limits the maximum velocity of the balls."},{name:"maxX",type:"number",default:"5",description:"Defines the maximum X-coordinate boundary."},{name:"maxY",type:"number",default:"5",description:"Defines the maximum Y-coordinate boundary."},{name:"maxZ",type:"number",default:"2",description:"Defines the maximum Z-coordinate boundary."}],[]);return n.jsx(w,{props:h,defaultProps:d,resetProps:m,hasChanges:f,children:n.jsxs(z,{children:[n.jsxs(P,{children:[n.jsxs(y,{position:"relative",className:"demo-container",minH:600,maxH:600,overflow:"hidden",children:[n.jsx(D,{onClick:t}),n.jsx(k,{className:"ballpit-demo",count:o,gravity:a,friction:r,wallBounce:c,followCursor:l,colors:u},p),n.jsx(B,{pillText:"New Background",headline:"Balls! What's not to like about them?"})]}),n.jsx(b,{justify:"flex-end",mt:2,mb:-2,children:n.jsx(M,{backgroundId:"ballpit",currentProps:{count:o,gravity:a,friction:r,wallBounce:c,followCursor:l},defaultProps:{count:100,gravity:.5,friction:.9975,wallBounce:.95,followCursor:!0,colors:["#5227FF","#7cff67","#ff6b6b"]}})}),n.jsxs(I,{children:[n.jsx(L,{title:"Display Cursor",isChecked:l,onChange:e=>{i("followCursor",e),t()}}),n.jsx(s,{title:"Ball Count",min:50,max:500,step:10,value:o,onChange:e=>{i("count",e),t()}}),n.jsx(s,{title:"Gravity",min:0,max:1,step:.1,value:a,onChange:e=>{i("gravity",e),t()}}),n.jsx(s,{title:"Friction",min:.9,max:1,step:.001,value:r,onChange:e=>{i("friction",e),t()}}),n.jsx(s,{title:"Wall Bounce",min:.5,max:1,step:.05,value:c,onChange:e=>{i("wallBounce",e),t()}})]}),n.jsx(C,{data:g}),n.jsx(S,{dependencyList:["three"]})]}),n.jsx(R,{children:n.jsx(A,{codeObject:F,componentName:"Ballpit"})})]})})};export{tn as default};
