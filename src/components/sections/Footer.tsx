                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-24">
                    ...
                    <div>
                        ...
                        <div className="space-y-5 font-sans text-[14px] text-text-secondary">
                            ...
                            <a href="https://wa.me/919999999999" target="_blank" rel="noopener noreferrer" className="pt-4 block text-pulse-cyan hover:text-white transition-colors font-medium text-[14px]">
