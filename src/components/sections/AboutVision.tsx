        ...
        <section id="about" ref={containerRef} className="py-16 relative z-10 flex flex-col justify-center overflow-hidden">
            ...
            <div className="max-w-[1200px] mx-auto px-[max(24px,4vw)] relative z-20">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-6 relative z-20">
                    ...
                    <div className="glass-1 p-6 flex flex-col items-center justify-center rounded-2xl border border-white/5">
                        <div className="font-mono text-xl text-gradient font-bold mb-2 uppercase tracking-[0.2em] text-center">
                            Global
                        </div>
                        <div className="font-sans text-sm text-text-secondary uppercase tracking-wider">Impact</div>
                    </div>
