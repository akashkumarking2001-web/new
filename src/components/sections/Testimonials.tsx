...
export default function Testimonials() {
    ...
    return (
        <section className="py-14 relative z-10 w-full overflow-hidden" id="testimonials">
                                    ...
                                    <div className="flex items-center justify-between mt-auto">
                                        <div className="flex items-center gap-4">
                                            <div className="w-12 h-12 rounded-full overflow-hidden border border-white/10 glass-1 relative">
                                                <Image src={t.image} alt={t.name} fill sizes="(max-width: 768px) 48px, 48px" className="object-cover" />
                                            </div>
                                            <div>
