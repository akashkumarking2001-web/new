...
const OPTIONS = {
    ...
    timeline: [
        { id: "standard", label: "Standard (8-12 weeks)", multiplier: 1, desc: "Regular sprint cycles" },
        { id: "fast", label: "Fast-Track (4-6 weeks)", multiplier: 1.3, desc: "Dedicated squad, daily commits" },
    ]
};
...
export default function Estimator() {
    ...
    return (
        <section className="py-24 relative z-10 w-full overflow-hidden" id="estimator">
                    ...
                    {!isCalculated ? (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-4">
                                ...
                                <button className="px-8 py-3 rounded-full font-sans font-semibold text-[14px] text-white bg-axo-gradient hover:scale-105 transition-transform shadow-[0_0_20px_rgba(123,47,232,0.4)]">
                                    Book Discovery Call
                                </button>
                            </div>
                        </motion.div>
