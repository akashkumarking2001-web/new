                ...
                <div className="space-y-8 mt-12 lg:mt-0">
                    ...
                    >
                        {[
                            ...
                            <motion.div key={i} className="glass-1 px-5 py-3 hover:-translate-y-1 transition-transform">
                                <div className="font-syne font-bold text-xl text-gradient">{stat.num}</div>
                                <div className="font-sans text-[12px] text-text-secondary uppercase tracking-wider">{stat.label}</div>
                            </motion.div>
                        ))}
                    </motion.div>
                    ...
                    >
                        <button className="h-[56px] px-9 rounded-full bg-axo-gradient font-sans font-semibold text-[15px] text-white hover:scale-105 transition-all duration-300 shadow-[0_0_20px_rgba(123,47,232,0.4)] relative overflow-hidden group">
                            <span className="relative z-10">Start Your Project →</span>
                            <div className="absolute inset-0 bg-white/20 opacity-0 group-hover:opacity-100 transition-opacity" />
                        </button>
                        <button className="gradient-border h-[56px] px-9 rounded-[28px] font-sans font-medium text-[15px] group overflow-hidden">
                            <span className="relative z-10 text-white group-hover:text-pulse-cyan transition-colors">View Our Work</span>
