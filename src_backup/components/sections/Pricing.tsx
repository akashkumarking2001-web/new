...
export default function Pricing() {
    ...
    return (
        <section className="py-24 relative z-10 w-full overflow-hidden" id="pricing">
                    ...
                    {TIERS.map((tier, i) => (
                        ...
                        >
                            ...
                            <div className="pt-6 border-t border-white/10 mt-auto">
                                ...
                                <button className={`w-full py-4 rounded-full font-sans font-semibold text-[15px] transition-all duration-300 ${tier.popular ? 'bg-axo-gradient text-white shadow-[0_0_20px_rgba(123,47,232,0.3)] hover:scale-[1.02]' : 'glass-1 border border-white/10 text-white hover:border-pulse-cyan hover:text-pulse-cyan'}`}>
                                    {tier.cta}
                                </button>
                            </div>
                        </motion.div>
